package net.busybee.autopickup.commands;
...
public class AutoPickupCommand extends AbstractPlayerCommand {
    ...
    public static class SettingsSubCommand extends AbstractPlayerCommand {
        ...
        protected void execute(
            ...
            int radius = plugin.getPluginConfig().getPickupRadius();
            String notification = plugin.getPluginConfig().getNotificationType();
