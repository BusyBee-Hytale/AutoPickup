package net.busybee.autopickup.util;
...
public class ConfigValidator {
    ...
    public void validateAndRepair() {
        ...
        validateEnum(config, "database.type", "sqlite", Arrays.asList("sqlite", "mysql", "mariadb"));
        validateIntRange(config, "database.port", 3306, 1, 65535);
        validateIntRange(config, "database.pool-size", 10, 1, 100);
